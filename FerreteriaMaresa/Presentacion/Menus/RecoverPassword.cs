...
namespace Presentacion
{
    public partial class RecoverPassword : Form
    {
        ...
        private void btnVerCont_Click(object sender, EventArgs e)
        {
            txtpassword.UseSystemPasswordChar = ((txtpassword.UseSystemPasswordChar == true) ? false : true);
              
        }

        private void btnVerConf_Click(object sender, EventArgs e)
        {
            txtconfirmpass.UseSystemPasswordChar = ((txtconfirmpass.UseSystemPasswordChar == true) ? false : true);
        }
    }
}
